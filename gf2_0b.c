...
void
p_gf2_factor( int bit_size, uint32_t* x, uint32_t* irreducible_factors, int* irreducible_factor_count )
{
  ...
  p_gf2_sff( bit_size, x, &sf_factor_count, sf_factors, sf_factors_pow, 0 );
  ...
  for (int i=0;i<sf_factor_count;i++)
  {
    ...
    p_gf2_berlekamp_irreducible_factors( bit_size, f, &irreducible_factor_count, irreducible_factors );
